...
È di fondamentale importanza riconoscere quando e come utilizzare dispositivi quali puntatori laser e torce montati sull'arma; un utilizzo improprio può essere molto deleterio (Laser/Light Discipline).
...
È fondamentale assicurarsi il corretto posizionamento degli operatori all'interno dell'ambiente e che la volata delle armi non sia mai puntata contro altri operatori (Muzzle Discipline), ad esempio utilizzando la posizione High Ready.

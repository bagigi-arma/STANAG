...
force ace_medical_treatment_allowSharedEquipment = 3;
...
force kat_breathing_PortableOxygenTank_RefillTime = 10;
...
force kat_breathing_SpO2_MultiplyNegative = 1.3;
force kat_breathing_SpO2_MultiplyPositive = 1.4;
force kat_breathing_SpO2_perfusion = true;
force kat_breathing_SpO2_PerfusionMultiplier = 1.4;
...
force kat_circulation_hardcoreDiagnose = true;
...
force kat_circulation_treatmentTime_BPCuff = 8;
force kat_circulation_treatmentTime_StethHR = 6;
...
force kat_pharma_treatmentTime_CWMP = 4;
...
force kat_pharma_treatmentTime_Penthrox = 5;
